...
if(isset($_REQUEST['submit']))
{
	...
	echo "<h1> Total Marks is : ".$total."</h1>";
	...
	elseif($per>70)
	{
		echo $grade="<h1 style='color:green'>  B+ Garde </h1>";
	}
	elseif($per>60)
	{
		echo $grade="<h1 style='color:green'>  B Garde </h1>";
	...
	elseif($per>50)
	{
		echo $grade="<h1 style='color:green'>  C+ Garde  </h1>";
	}
	elseif($per>40)
	{
		echo $grade="<h1 style='color:green'>  C Garde </h1>";
	...
	{
		echo $grade="<h1 style='color:red'>  Fail </h1>";
	}	
}
