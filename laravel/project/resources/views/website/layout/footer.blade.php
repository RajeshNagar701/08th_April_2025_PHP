    ...
    <script src="<?php echo url('website/lib/wow/wow.min.js')?>"></script>
    <script src="<?php echo url('website/lib/easing/easing.min.js')?>"></script>
    <script src="<?php echo url('website/lib/waypoints/waypoints.min.js')?>"></script>
    <script src="<?php echo url('website/lib/counterup/counterup.min.js')?>"></script>
    <script src="<?php echo url('website/lib/lightbox/js/lightbox.min.js')?>"></script>
