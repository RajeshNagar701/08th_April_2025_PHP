            ...
            <div class="row g-0 align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="owl-carousel header-carousel animated fadeIn">
                        <img class="img-fluid" src="<?php echo url('website/img/hero-slider-1.jpg')?>" alt="">
                        <img class="img-fluid" src="<?php echo url('website/img/hero-slider-2.jpg')?>" alt="">
                        <img class="img-fluid" src="<?php echo url('website/img/hero-slider-3.jpg')?>" alt="">
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeIn" data-wow-delay="0.2s">
                    <img class="img-fluid mb-3" src="<?php echo url('website/img/about.jpg')?>" alt="">
            ...
            <div class="row g-4 g-md-0 text-center">
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-end wow fadeIn" data-wow-delay="0.1s">
                        <img class="img-fluid" src="<?php echo url('website/img/haircut.png')?>" alt="">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-lg-end wow fadeIn" data-wow-delay="0.3s">
                        <img class="img-fluid" src="<?php echo url('website/img/makeup.png')?>" alt="">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-end border-lg-end-0 wow fadeIn"
                        data-wow-delay="0.5s">
                        <img class="img-fluid" src="<?php echo url('website/img/manicure.png')?>" alt="">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-bottom border-lg-bottom-0 border-lg-end wow fadeIn"
                        data-wow-delay="0.1s">
                        <img class="img-fluid" src="<?php echo url('website/img/pedicure.png')?>" alt="">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 border-end wow fadeIn" data-wow-delay="0.3s">
                        <img class="img-fluid" src="<?php echo url('website/img/massage.png')?>" alt="">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="service-item h-100 p-4 wow fadeIn" data-wow-delay="0.5s">
                        <img class="img-fluid" src="<?php echo url('website/img/skin-care.png')?>" alt="">
            ...
            <div class="col-md-6">
                <div class="h-100 bg-dark p-5">
                    <div class="price-item mb-3 wow fadeIn" data-wow-delay="0.1s">
                        <img class="img-fluid flex-shrink-0" src="<?php echo url('website/img/price-1.jpg')?>" alt="">
                    ...
                    <div class="price-item mb-3 wow fadeIn" data-wow-delay="0.2s">
                        <img class="img-fluid flex-shrink-0" src="<?php echo url('website/img/price-2.jpg')?>" alt="">
                        <div class="text-end px-4">
                    ...
                    <div class="price-item mb-3 wow fadeIn" data-wow-delay="0.3s">
                        <img class="img-fluid flex-shrink-0" src="<?php echo url('website/img/price-3.jpg')?>" alt="">
                        <div class="text-end px-4">
                    ...
                    <div class="price-item mb-3 wow fadeIn" data-wow-delay="0.4s">
                        <img class="img-fluid flex-shrink-0" src="<?php echo url('website/img/price-4.jpg')?>" alt="">
                        <div class="text-end px-4">
                    ...
                    <div class="price-item mb-3 wow fadeIn" data-wow-delay="0.5s">
                        <img class="img-fluid flex-shrink-0" src="<?php echo url('website/img/price-5.jpg')?>" alt="">
                        <div class="text-end px-4">
                    ...
                    <div class="price-item mb-3 wow fadeIn" data-wow-delay="0.6s">
                        <img class="img-fluid flex-shrink-0" src="<?php echo url('website/img/price-6.jpg')?>" alt="">
                        <div class="text-end px-4">
            ...
            <div class="row g-4 team">
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.1s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo url('website/img/team-1.jpg')?>" alt="">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.3s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo url('website/img/team-2.jpg')?>" alt="">
                        <div class="team-overlay">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.5s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo url('website/img/team-3.jpg')?>" alt="">
                        <div class="team-overlay">
                ...
                <div class="col-md-6 col-lg-3 wow fadeIn" data-wow-delay="0.7s">
                    <div class="team-item position-relative overflow-hidden">
                        <img class="img-fluid w-100" src="<?php echo url('website/img/team-4.jpg')?>" alt="">
                        <div class="team-overlay">
